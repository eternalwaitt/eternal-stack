...
export const REGISTERED_DEEP_AUDIT_CATEGORIES = [
  ...
  },
  {
    ...
    checks: [
      check("perf-01-database-query-performance", "Database query performance", ["perf_queries", "perf_procedures", "perf_request_graph", "perf_relations"], "Database query or procedure worklist exists", "database-query-performance"),
      check("perf-02-server-response-caching", "Server response time, caching, and request fanout", ["perf_pages", "perf_route_handlers", "perf_dynamic_routes", "perf_procedures", "perf_request_graph"], "Pages, procedures, or route handlers exist", "server-response-caching"),
      ...
      check("perf-05-perceived-performance", "Perceived performance and UX speed", ["perf_pages", "perf_loading", "perf_client", "perf_request_graph"], "User-facing pages exist", "perceived-performance"),
      check("perf-06-infrastructure-network", "Infrastructure, network, and runtime memory", ["perf_route_handlers", "perf_next_configs", "perf_large_files", "perf_request_graph", "perf_relations", "perf_provider_incidents"], "Routes, config, assets, or provider incidents exist", "infrastructure-network"),
    ],
    lanes: [
      lane("database-query-performance", "Database query performance", ["perf_queries", "perf_procedures", "perf_request_graph", "perf_relations"], "standard"),
      lane("server-response-caching", "Server response time, caching, and request fanout", ["perf_pages", "perf_route_handlers", "perf_dynamic_routes", "perf_procedures", "perf_request_graph"], "standard"),
      ...
      lane("perceived-performance", "Perceived performance and UX speed", ["perf_pages", "perf_loading", "perf_client", "perf_request_graph"], "standard"),
      lane("infrastructure-network", "Infrastructure, network, and runtime memory", ["perf_route_handlers", "perf_next_configs", "perf_large_files", "perf_request_graph", "perf_relations", "perf_provider_incidents"], "fast"),
    ],
  },
  {
