...
| [0004](0004-coderabbit-preemption-lean.md) | accepted | Preempt CodeRabbit findings with three lean controls (deterministic guard, plan checklist, review lens) plus a warn-first auto-learning loop; extract data and re-express code from the Codex receipt cathedral rather than salvage it; scope-freeze planning gate to prevent regrowth. |
