...
| etrnl-deep-audit | P1 | M2 | telemetry_proactive:surface stale or missing category coverage in workflow-health when the deep-audit registry changes |
...
| etrnl-code-review-excellence | P2 | M3 | none |
...
| etrnl-backend-patterns | P2 | M3 | none |
