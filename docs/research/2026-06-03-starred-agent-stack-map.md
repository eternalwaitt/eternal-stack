...
| P0 | `github/spec-kit` | steal/adopt gates | Strongest spec -> plan -> tasks -> implement pipeline; better task/checklist executability gates than section checks. | `plan-readiness-check.mjs`, `etrnl-dev-plan`, `etrnl-execute` |
