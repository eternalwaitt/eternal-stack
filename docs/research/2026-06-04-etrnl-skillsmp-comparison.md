...
- Prompt-budget risks: `etrnl-execute`, `etrnl-autoplan`, and `etrnl-dev-plan` are already large. Additions there must stay short; move extended examples to references or validators.
...
- `skills/etrnl-dev-plan/SKILL.md` and `skills/etrnl-autoplan/SKILL.md`: add compact vertical-slice/task-sizing guard.
