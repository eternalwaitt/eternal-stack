...
| Writing plans flow | done: file-backed draft, review, improve, final, short chat summary. |
| Execution flow | done: phase gates, critical review, verification, final simplification/dedupe/domain passes. |
...
| Install/update/rollback/doctor | done: scripts, tests, rollback, canaries, rules, docs, and templates are installed or checked. |
