...
jq -nc '{schemaVersion:4,reads:{},searches:{},edits:{},commands:[],blockedCommands:[],successfulCommands:[{command:"vivaz-email triage guarded-run --account agencia --max-inbox 500 --apply --allow-apply-before-enrichment --progress",at:"2026-01-01T00:00:01Z"}],failures:[],skillCalls:[],agentCalls:[],reviewerAgentCalls:[],requestedSkills:[{value:"email-triage",at:"2026-01-01T00:00:00Z"}],evidenceChallenges:[],evidenceDisciplineViolations:[],evidenceViolationFingerprints:{},warningFingerprints:{},verificationRuns:[],qualityRuns:[],testRuns:[],browserRuns:[],reviewRuns:[],newFileSearches:[],newSourceFiles:{},editCounts:{},largeEdits:[],repeatedEditFiles:{},reviewTriggers:[],editGeneration:0,commandLastEditGeneration:{},prodApprovalMarkers:[],lastPrompt:"/email-triage agencia",lastCompactSummary:"",lastCompactAt:"",compactCount:0,cwd:"",settingsFingerprint:"",startedAt:"2026-01-01T00:00:00Z"}' >"$email_triage_queue_before_verify_state"
email_triage_queue_before_verify="$(jq '.session_id = "fixture-email-triage-queue-before-verify" | .tool_input.command = "vivaz-email triage queue --run-id triage_fixture --mode review --format markdown --next"' <<<"$bash_json")"
...
jq -nc '{schemaVersion:4,reads:{},searches:{},edits:{},commands:[],blockedCommands:[],successfulCommands:[{command:"vivaz-email triage guarded-run --account agencia --max-inbox 500 --apply --allow-apply-before-enrichment --progress",at:"2026-01-01T00:00:01Z"},{command:"vivaz-email triage verify --latest --account agencia",at:"2026-01-01T00:00:02Z"}],failures:[],skillCalls:[],agentCalls:[],reviewerAgentCalls:[],requestedSkills:[{value:"email-triage",at:"2026-01-01T00:00:00Z"}],evidenceChallenges:[],evidenceDisciplineViolations:[],evidenceViolationFingerprints:{},warningFingerprints:{},verificationRuns:[],qualityRuns:[],testRuns:[],browserRuns:[],reviewRuns:[],newFileSearches:[],newSourceFiles:{},editCounts:{},largeEdits:[],repeatedEditFiles:{},reviewTriggers:[],editGeneration:0,commandLastEditGeneration:{},prodApprovalMarkers:[],lastPrompt:"/email-triage agencia",lastCompactSummary:"",lastCompactAt:"",compactCount:0,cwd:"",settingsFingerprint:"",startedAt:"2026-01-01T00:00:00Z"}' >"$email_triage_queue_after_verify_state"
email_triage_queue_after_verify="$(jq '.session_id = "fixture-email-triage-queue-after-verify" | .tool_input.command = "vivaz-email triage queue --run-id triage_fixture --mode review --format markdown --next"' <<<"$bash_json")"
...
email_triage_guarded_timeout_state="$TMPROOT/claude-guard-fixture-email-triage-guarded-timeout.json"
jq -nc '{schemaVersion:4,reads:{},searches:{},edits:{},commands:[],blockedCommands:[],successfulCommands:[],failures:[],skillCalls:[],agentCalls:[],reviewerAgentCalls:[],requestedSkills:[{value:"email-triage",at:"2026-01-01T00:00:00Z"}],evidenceChallenges:[],evidenceDisciplineViolations:[],evidenceViolationFingerprints:{},warningFingerprints:{},verificationRuns:[],qualityRuns:[],testRuns:[],browserRuns:[],reviewRuns:[],newFileSearches:[],newSourceFiles:{},editCounts:{},largeEdits:[],repeatedEditFiles:{},reviewTriggers:[],editGeneration:0,commandLastEditGeneration:{},prodApprovalMarkers:[],lastPrompt:"/email-triage agencia",lastCompactSummary:"",lastCompactAt:"",compactCount:0,cwd:"",settingsFingerprint:"",startedAt:"2026-01-01T00:00:00Z"}' >"$email_triage_guarded_timeout_state"
email_triage_guarded_timeout="$(jq '.session_id = "fixture-email-triage-guarded-timeout" | .tool_input.command = "vivaz-email triage guarded-run --account agencia --max-inbox 500 --apply --allow-apply-before-enrichment --progress" | .tool_input.timeout = 120000' <<<"$bash_json")"
out="$(run_hook cc-pretooluse-guard.sh "$email_triage_guarded_timeout")"
assert_json_expr "email triage blocks guarded-run bash timeout" "$out" '.hookSpecificOutput.permissionDecision == "deny"'
assert_contains "email triage guarded-run timeout reason" "$out" "Do not set Bash tool timeout on vivaz-email triage guarded-run"

email_triage_second_guarded_state="$TMPROOT/claude-guard-fixture-email-triage-second-guarded.json"
jq -nc '{schemaVersion:4,reads:{},searches:{},edits:{},commands:[],blockedCommands:[],successfulCommands:[{command:"vivaz-email triage guarded-run --account agencia --max-inbox 500 --apply --allow-apply-before-enrichment --progress",at:"2026-01-01T00:00:01Z"}],failures:[],skillCalls:[],agentCalls:[],reviewerAgentCalls:[],requestedSkills:[{value:"email-triage",at:"2026-01-01T00:00:00Z"}],evidenceChallenges:[],evidenceDisciplineViolations:[],evidenceViolationFingerprints:{},warningFingerprints:{},verificationRuns:[],qualityRuns:[],testRuns:[],browserRuns:[],reviewRuns:[],newFileSearches:[],newSourceFiles:{},editCounts:{},largeEdits:[],repeatedEditFiles:{},reviewTriggers:[],editGeneration:0,commandLastEditGeneration:{},prodApprovalMarkers:[],lastPrompt:"/email-triage agencia",lastCompactSummary:"",lastCompactAt:"",compactCount:0,cwd:"",settingsFingerprint:"",startedAt:"2026-01-01T00:00:00Z"}' >"$email_triage_second_guarded_state"
email_triage_second_guarded="$(jq '.session_id = "fixture-email-triage-second-guarded" | .tool_input.command = "vivaz-email triage guarded-run --account agencia --max-inbox 500 --apply --allow-apply-before-enrichment --progress"' <<<"$bash_json")"
out="$(run_hook cc-pretooluse-guard.sh "$email_triage_second_guarded")"
assert_json_expr "email triage blocks competing guarded-run before verify" "$out" '.hookSpecificOutput.permissionDecision == "deny"'
assert_contains "email triage competing guarded-run reason" "$out" "already in progress or awaiting verify"
...
JS
skill_update_prompt="$(jq -cn '{session_id:"fixture-skill-update-prompt",prompt:"/etrnl-dev-plan .claude/plans/example.md"}')"
...
assert_contains "email prompt emits exact guarded command" "$out" "vivaz-email triage guarded-run --account agencia --max-inbox 500 --apply --allow-apply-before-enrichment --progress"
...
assert_contains "email prompt emits review queue command" "$out" "vivaz-email triage queue --run-id <run-id> --account agencia --mode review --format markdown --next"
assert_contains "email prompt blocks guarded-run timeout" "$out" "Do not set a Bash tool timeout on guarded-run"
...
plan_exec_should_question_prompt="$(jq -cn '{session_id:"fixture-plan-exec-clear",prompt:"Should I execute the plan?"}')"
run_hook cc-userprompt-router.sh "$plan_exec_clear_prompt" >/dev/null || true
...
email_guard_failure_json="$(jq -cn '{session_id:"fixture-email-guard-failure",tool_name:"Bash",tool_input:{command:"vivaz-email triage guarded-run --account agencia --apply --allow-apply-before-enrichment --progress"},error:"TRIAGE_GUARD_ML_DISAGREED: ML archive review found 1 disagreement"}')"
...
zero_verify_url_question_state="$TMPROOT/claude-guard-fixture-zero-verify-url-question.json"
jq -nc --arg cwd "$zero_verify_repo" "$zero_verify_empty_state | .cwd = \$cwd" >"$zero_verify_url_question_state"
zero_verify_url_question_stop="$(jq -cn --arg cwd "$zero_verify_repo" '{session_id:"fixture-zero-verify-url-question",cwd:$cwd,last_assistant_message:"Done. Tests pass at https://example.com/run?id=1?debug=1.",stop_hook_active:false}')"
out="$(run_hook cc-stop-verifier.sh "$zero_verify_url_question_stop")"
assert_contains "stop verifier blocks positive claim even when unrelated URL contains question mark" "$out" "claim completion without verification evidence"
zero_verify_when_passing_state="$TMPROOT/claude-guard-fixture-zero-verify-when-passing.json"
jq -nc --arg cwd "$zero_verify_repo" "$zero_verify_empty_state | .cwd = \$cwd" >"$zero_verify_when_passing_state"
zero_verify_when_passing_stop="$(jq -cn --arg cwd "$zero_verify_repo" '{session_id:"fixture-zero-verify-when-passing",cwd:$cwd,last_assistant_message:"Done. When the tests are passing we can ship.",stop_hook_active:false}')"
out="$(run_hook cc-stop-verifier.sh "$zero_verify_when_passing_stop")"
if [[ -z "$out" ]]; then ok "stop verifier allows when-the-tests-are-passing hypothetical without runs"; else not_ok "when-the-tests-are-passing should pass without runs: $out"; fi
...
jq -nc '{schemaVersion:4,reads:{},searches:{},edits:{},commands:[],blockedCommands:[],successfulCommands:[],failures:[],skillCalls:[],agentCalls:[],reviewerAgentCalls:[],requestedSkills:[],evidenceChallenges:[],evidenceDisciplineViolations:[],evidenceViolationFingerprints:{},warningFingerprints:{},verificationRuns:[{value:"pnpm test",at:"2026-01-01T00:00:01Z"}],qualityRuns:[],testRuns:[],browserRuns:[],reviewRuns:[],newFileSearches:[],newSourceFiles:{},editCounts:{},largeEdits:[],repeatedEditFiles:{},reviewTriggers:[],editGeneration:0,commandLastEditGeneration:{},prodApprovalMarkers:[],activePlanPath:".claude/plans/example.md",activePlanPathUpdatedAt:"2026-01-01T00:00:00Z",planExecutionRequested:true,planExecutionRequestedAt:"2026-01-01T00:00:00Z",lastPrompt:"implement now",lastCompactSummary:"",lastCompactAt:"",compactCount:0,cwd:"",settingsFingerprint:"",startedAt:"2026-01-01T00:00:00Z"}' >"$plan_execution_no_ledger_state"
