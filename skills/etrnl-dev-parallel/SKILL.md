...
description: ETRNL parallel-agent workflow for Claude Code. Use only when the user explicitly asks for parallel agents; hidden from model auto-invocation because it delegates work.
