...
**CRITICAL**: If no design system exists, STOP and ask before creating one — use Codex's structured user-input/question tool when available; if unavailable, ask directly in chat. Understand the preferred location and structure first.
