...
Codex startup: `node ~/.codex/scripts/skill-update-prompt.mjs --agent codex --skill etrnl-commit`; on update, ask update/snooze/continue.
...
4. Use the `etrnl-test` preflight/test workflow for the project before staging.
