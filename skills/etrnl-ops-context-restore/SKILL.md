...
Codex startup: `node ~/.codex/scripts/skill-update-prompt.mjs --agent codex --skill etrnl-ops-context-restore`; on update, never stop to ask — continue the work; local updates auto-apply when enabled and safe.
