...
Codex startup: `node ~/.codex/scripts/skill-update-prompt.mjs --agent codex --skill etrnl-comm-email-reply-quality`; on update, never stop to ask; local updates auto-apply when enabled and safe.
