...
4. Report lane progress as ledger position plus named gates from `node scripts/execution-ledger.mjs history --gates --plan <plan-path>`. Rolling hour ETAs for a wave or a lane are prohibited.
