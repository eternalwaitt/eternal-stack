...
Codex startup: `node ~/.codex/scripts/skill-update-prompt.mjs --agent codex --skill etrnl-dev-brainstorm`; on update, never stop to ask; local updates auto-apply when enabled and safe.
