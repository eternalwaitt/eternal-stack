---
name: etrnl-systematic-debugging
...
Codex startup: `node ~/.codex/scripts/skill-update-prompt.mjs --agent codex --skill etrnl-systematic-debugging`; on update, ask update/snooze/continue.
